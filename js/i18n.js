...
(function () {
  ...
  const T = {
    en: {
      ...
      ll_title: 'Same place. Same vibe.<br>Now what?',
      ll_lead: 'Init Lounge is the “now what” — check in, drop a line, and meet the people who are actually here.',
      ll_step3_title: 'Connect, live',
      ...
      home_footer_tagline: 'Same place. Same vibe. Now what?',
    ...
    fr: {
      ...
      ll_title: 'Même endroit. Même ambiance.<br>Et maintenant ?',
      ll_lead: 'Init Lounge, c\'est le « et maintenant » : enregistrez-vous, laissez une ligne et rencontrez les gens qui sont vraiment là.',
      ll_step3_title: 'Connexion, en direct',
      ...
      ll_usp2_body: 'Montrez votre photo à tout le monde, ou seulement aux personnes avec qui la vibe est réciproque.',
      ...
      home_footer_tagline: 'Même endroit. Même ambiance. Et maintenant ?',
    ...
    it: {
      ...
      ll_title: 'Stesso posto. Stessa vibe.<br>E adesso?',
      ll_lead: 'Init Lounge è proprio quell\'«e adesso»: fai il check-in, lascia una riga e incontra le persone che sono davvero qui.',
      ll_step3_title: 'Connessione, dal vivo',
      ...
      home_footer_tagline: 'Stesso posto. Stessa vibe. E adesso?',
    ...
    es: {
      ...
      ll_title: 'Mismo lugar. Misma onda.<br>¿Y ahora qué?',
      ll_lead: 'Init Lounge es ese «y ahora qué»: regístrate, deja una línea y conoce a la gente que está aquí de verdad.',
      ll_step3_title: 'Conecta, en vivo',
      ...
      home_footer_tagline: 'Mismo lugar. Misma onda. ¿Y ahora qué?',
    ...
    hi: {
      ...
      ll_title: 'वही जगह। वही वाइब।<br>अब आगे क्या?',
      ll_lead: 'Init Lounge वही “अब आगे क्या” है — चेक इन करें, एक लाइन लिखें, और उन लोगों से मिलें जो सचमुच यहीं मौजूद हैं।',
      ll_step3_title: 'कनेक्ट, लाइव',
      ...
      home_footer_tagline: 'वही जगह। वही वाइब। अब आगे क्या?',
    ...
    zh: {
      ...
      btn_get_app: '下载应用 →',
      ll_title: '同一个地方。同一种氛围。<br>然后呢？',
      ll_lead: 'Init Lounge 就是这个“然后呢”——签到、写下一句话，认识此刻真正在场的人。',
      ll_step3_title: '实时连接',
      ...
      home_footer_tagline: '同一个地方。同一种氛围。然后呢？',
    ...
    bn: {
      ...
      ll_title: 'একই জায়গা। একই ভাইব।<br>এখন কী?',
      ll_lead: 'Init Lounge-ই সেই “এখন কী” — চেক ইন করুন, এক লাইন লিখুন, আর যাঁরা সত্যিই এখানে আছেন তাঁদের সঙ্গে পরিচিত হন।',
      ll_step3_title: 'কানেক্ট, লাইভ',
      ...
      home_footer_tagline: 'একই জায়গা। একই ভাইব। এখন কী?',
    ...
    te: {
      ...
      ll_title: 'అదే స్థలం. అదే వైబ్.<br>ఇప్పుడు ఏంటి?',
      ll_lead: 'Init Lounge అంటేనే ఆ “ఇప్పుడు ఏంటి” — చెక్ ఇన్ అవ్వండి, ఒక లైన్ రాయండి, ఇప్పుడు నిజంగా ఇక్కడ ఉన్నవారిని కలవండి.',
      ll_step3_title: 'కనెక్ట్, ప్రత్యక్షంగా',
      ...
      home_footer_tagline: 'అదే స్థలం. అదే వైబ్. ఇప్పుడు ఏంటి?',
    ...
    mr: {
      ...
      ll_title: 'तीच जागा. तोच वाइब.<br>आता पुढे काय?',
      ll_lead: 'Init Lounge म्हणजेच ते “आता पुढे काय” — चेक इन करा, एक ओळ लिहा आणि आत्ता खरोखर इथे असलेल्या लोकांना भेटा.',
      ll_step3_title: 'कनेक्ट, लाइव्ह',
      ...
      home_footer_tagline: 'तीच जागा. तोच वाइब. आता पुढे काय?',
    ...
    ta: {
      ...
      ll_title: 'அதே இடம். அதே வைப்.<br>இப்போது என்ன?',
      ll_lead: 'Init Lounge தான் அந்த “இப்போது என்ன” — செக் இன் செய்யுங்கள், ஒரு வரி எழுதுங்கள், இப்போது உண்மையில் இங்கே இருப்பவர்களைச் சந்தியுங்கள்.',
      ll_step3_title: 'இணைப்பு, நேரடியாக',
      ...
      home_footer_tagline: 'அதே இடம். அதே வைப். இப்போது என்ன?',
    ...
    kn: {
      ...
      ll_title: 'ಅದೇ ಸ್ಥಳ. ಅದೇ ವೈಬ್.<br>ಈಗ ಏನು?',
      ll_lead: 'Init Lounge ಎಂದರೆ ಅದೇ “ಈಗ ಏನು” — ಚೆಕ್ ಇನ್ ಮಾಡಿ, ಒಂದು ಸಾಲು ಬರೆಯಿರಿ, ಈಗ ನಿಜವಾಗಿಯೂ ಇಲ್ಲಿ ಇರುವವರನ್ನು ಭೇಟಿಯಾಗಿ.',
      ll_step3_title: 'ಸಂಪರ್ಕ, ಲೈವ್',
      ...
      home_footer_tagline: 'ಅದೇ ಸ್ಥಳ. ಅದೇ ವೈಬ್. ಈಗ ಏನು?',
